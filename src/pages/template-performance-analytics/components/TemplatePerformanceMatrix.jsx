          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {templates.map((template) => {
              ...
              return (
                <div
                  key={template.id}
                  className="group relative bg-secondary-50 rounded-lg overflow-hidden hover:shadow-elevation-md nav-transition cursor-pointer"
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    {formattedLift && (
                      <div className={`absolute top-3 right-3 px-2 py-1 rounded-full text-xs font-medium ${
                        template.abTestLift > 0 ? 'bg-success text-white' : 'bg-error text-white'
                      }`}>
                        {formattedLift}
                      </div>
                    )}
                    ...
                    <div className="flex items-center justify-between text-xs">
                      <div className="flex items-center space-x-2">
                        ...
                        <div className={`px-2 py-1 rounded-full text-xs ${
                          template.subjectLinePerformance === 'high' ? 'bg-success-50 text-success' :
