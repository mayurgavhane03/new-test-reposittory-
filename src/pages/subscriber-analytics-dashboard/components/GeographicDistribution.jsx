...
const GeographicDistribution = ({ selectedCampaigns, selectedSegment }) => {
          ...
          {topRegions.map((region, index) => (
            ...
            >
              <button
                ...
                className={`w-3 h-3 rounded-full border-2 border-white shadow-md micro-interaction ${
      ...
      <div className="space-y-2">
        {topRegions.map((region, index) => (
          <button
            key={region.country}
            onClick={() => handleRegionClick(region)}
            className={`w-full flex items-center justify-between p-3 rounded-lg nav-transition ${
              selectedRegion?.country === region.country 
