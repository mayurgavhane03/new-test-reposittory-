      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="relative" ref={segmentRef}>
            ...
            {isSegmentOpen && (
              <div className="absolute top-full left-0 mt-1 w-64 bg-surface border border-border rounded-lg shadow-elevation-md z-1100 animate-slide-down">
                <div className="p-2">
                  ...
                  {segmentOptions.map((segment) => (
                    <button
                      ...
                      className={`w-full flex items-center justify-between p-3 hover:bg-secondary-50 rounded-lg nav-transition ${
                        selectedSegment === segment.id ? 'bg-primary-50 border-r-2 border-primary' : ''
                      }`}
                    >
          ...
          <div className="relative" ref={demographicRef}>
            ...
            {isDemographicOpen && (
              <div className="absolute top-full left-0 mt-1 w-56 bg-surface border border-border rounded-lg shadow-elevation-md z-1100 animate-slide-down">
                <div className="p-2">
                  <div className="text-xs font-medium text-text-secondary px-3 py-2 border-b border-border mb-2">
                    Age Groups
                  </div>
          ...
          <div className="relative" ref={behaviorRef}>
            ...
            {isBehaviorOpen && (
              <div className="absolute top-full left-0 mt-1 w-72 bg-surface border border-border rounded-lg shadow-elevation-md z-1100 animate-slide-down">
                <div className="p-2">
                  <div className="text-xs font-medium text-text-secondary px-3 py-2 border-b border-border mb-2">
                    Engagement Levels
                  </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className={`flex items-center space-x-2 px-3 py-2 rounded-lg nav-transition ${
              showCohortAnalysis 
