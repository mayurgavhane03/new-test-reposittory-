...
const CohortAnalysis = ({ selectedCampaigns, selectedPeriod, selectedSegment }) => {
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center bg-secondary-50 rounded-lg p-1">
            <button
              ...
              className={`px-3 py-1 text-sm font-medium rounded nav-transition ${
                viewType === 'retention' ?'bg-primary text-white' :'text-text-secondary hover:text-text-primary'
              }`}
            >
              Retention
            </button>
            <button
              ...
              className={`px-3 py-1 text-sm font-medium rounded nav-transition ${
                viewType === 'revenue' ?'bg-primary text-white' :'text-text-secondary hover:text-text-primary'
              }`}
            >
              Revenue
            </button>
                  ...
                  return (
                    <td key={periodIndex} className="p-3 text-center">
                      <button
                        ...
                        className={`px-2 py-1 rounded text-xs font-medium micro-interaction ${
                          getRetentionColor(periodData.retention)
                        }`}
                      >
                        {displayValue}
                      </button>
