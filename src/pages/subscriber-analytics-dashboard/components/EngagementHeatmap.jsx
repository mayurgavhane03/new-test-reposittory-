...
const EngagementHeatmap = ({ selectedCampaigns, selectedPeriod, selectedSegment }) => {
              ...
              {Array.from({ length: 24 }, (_, hour) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-1 min-w-6 h-8 m-0.5 rounded text-xs font-medium micro-interaction ${
                      getIntensityColor(cellData.engagement)
