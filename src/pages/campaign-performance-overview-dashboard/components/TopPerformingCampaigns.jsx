...
const TopPerformingCampaigns = ({ selectedCampaigns, dateRange, isLoading }) => {
  ...
  const CampaignCard = ({ campaign, rank }) => (
    <div className="flex items-center space-x-4 p-4 hover:bg-secondary-50 rounded-lg nav-transition">
      {/* Rank Badge */}
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          ...
          <div className="flex items-center">
            ...
            <div className={`flex items-center ml-1 ${
              campaign.trend === 'up' ? 'text-success' : 'text-error'
            }`}>
              <Icon 
