  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center space-x-3 px-4 py-2 bg-secondary-50 hover:bg-secondary-100 border border-border rounded-lg nav-transition"
      >
            ...
            {dateRangeOptions.map((option) => (
              <button
                ...
                className={`w-full flex items-start space-x-3 p-3 hover:bg-secondary-50 rounded-lg nav-transition ${
                  value === option.value ? 'bg-primary-50 border-r-2 border-primary' : ''
                }`}
              >
