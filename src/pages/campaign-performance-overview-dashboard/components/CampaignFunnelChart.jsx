...
const CampaignFunnelChart = ({ selectedCampaigns, comparisonMode, dateRange, isLoading }) => {
  // Mock funnel data
  const funnelData = [
    {
      stage: 'Sent',
  ...
  const FunnelStage = ({ stage, index }) => {
    ...
    return (
      <div className="flex items-center space-x-4 p-4 bg-surface border border-border rounded-lg hover:shadow-elevation-sm nav-transition">
        <div 
