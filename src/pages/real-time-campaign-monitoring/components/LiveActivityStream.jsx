...
const LiveActivityStream = ({ isLiveMode, refreshInterval }) => {
        ...
        {activities.length === 0 ? (
          ...
          <div className="p-4 space-y-3">
            {activities.map((activity, index) => (
              <div
                key={activity.id}
                className={`flex items-start space-x-3 p-3 rounded-lg hover:bg-secondary-50 nav-transition ${
                  index === 0 && isLiveMode ? 'animate-pulse bg-primary-50' : ''
                }`}
              >
