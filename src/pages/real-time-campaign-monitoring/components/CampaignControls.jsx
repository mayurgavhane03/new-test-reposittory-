              ...
              <div className="w-full bg-secondary-200 rounded-full h-2 mb-2">
                <div 
                  className={`h-2 rounded-full transition-all duration-300 ${
                    campaignHealth.status === 'healthy' ? 'bg-success' :
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className={`w-full flex items-center justify-center space-x-2 px-4 py-3 rounded-lg nav-transition ${
                currentCampaign.status === 'active' ?'bg-warning hover:bg-warning-600 text-white' :'bg-success hover:bg-success-600 text-white'
            ...
            <button
              ...
              className={`w-full flex items-center justify-center space-x-2 px-4 py-3 bg-error hover:bg-error-700 text-white rounded-lg nav-transition ${
                isProcessing || currentCampaign.status !== 'active' ? 'opacity-50 cursor-not-allowed' : ''
              }`}
            >
            ...
            <button
              ...
              disabled={isProcessing}
              className={`w-full flex items-center justify-center space-x-2 px-4 py-3 bg-secondary-100 hover:bg-secondary-200 text-text-primary rounded-lg nav-transition ${
                isProcessing ? 'opacity-50 cursor-not-allowed' : ''
              }`}
            >
          ...
          <div>
            ...
            <div className="space-y-2">
              <button
                ...
                disabled={isProcessing}
                className={`w-full flex items-center justify-center space-x-2 px-4 py-3 bg-primary hover:bg-primary-700 text-white rounded-lg nav-transition ${
                  isProcessing ? 'opacity-50 cursor-not-allowed' : ''
                }`}
              >
              ...
              <button
                ...
                disabled={isProcessing}
                className={`w-full flex items-center justify-center space-x-2 px-4 py-3 bg-accent hover:bg-accent-600 text-white rounded-lg nav-transition ${
                  isProcessing ? 'opacity-50 cursor-not-allowed' : ''
                }`}
              >
