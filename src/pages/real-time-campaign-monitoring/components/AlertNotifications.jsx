...
const AlertNotifications = ({ campaignHealth, liveMetrics }) => {
  ...
  const getAlertColor = (type) => {
    switch (type) {
      case 'critical': return 'text-error bg-error-50 border-error-100';
      case 'warning': return 'text-warning bg-warning-50 border-warning-100';
      case 'info': return 'text-primary bg-primary-50 border-primary-100';
      case 'success': return 'text-success bg-success-50 border-success-100';
