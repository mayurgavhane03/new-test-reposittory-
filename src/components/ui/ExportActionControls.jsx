    ...
    <div className="flex items-center space-x-3">
      ...
      <div className="relative" ref={exportRef}>
        <button
          ...
          className={`flex items-center space-x-2 px-4 py-2 bg-secondary-50 hover:bg-secondary-100 border border-border rounded-lg nav-transition ${
        ...
        {isExportOpen && !isExporting && (
          <div className="absolute right-0 top-full mt-1 w-64 bg-surface border border-border rounded-lg shadow-elevation-md z-1100 animate-slide-down">
            <div className="p-2">
              ...
              {currentExportOptions.map((option) => (
                <button
                  ...
                  className="w-full flex items-start space-x-3 p-3 hover:bg-secondary-50 rounded-lg nav-transition"
                >
      ...
      <div className="relative" ref={actionRef}>
        <button
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-primary hover:bg-primary-700 text-white rounded-lg nav-transition"
            ...
            <div className="p-2">
              ...
              {currentActionOptions.map((option) => (
                <button
                  ...
                  className={`w-full flex items-start space-x-3 p-3 hover:bg-secondary-50 rounded-lg nav-transition ${
                    option.danger ? 'hover:bg-error-50' : ''
                  }`}
                >
                  <Icon 
                    name={option.icon} 
                  ...
                  <div className="text-left">
                    <div className={`font-medium text-sm ${
                      option.danger ? 'text-error' : 'text-text-primary'
                    }`}>
                      {option.label}
                    </div>
                    <div className="text-xs text-text-secondary">
